...
This is a Python-package which generates a 2D solar (or rather stelar) system consisting of one sun and a user-defined number of planets orbiting around the sun in circular orbits. See the full project description [here](https://sites.google.com/view/python3-umk/projects#h.6plj5vogra3y). The code is structured as follows:
